...
<head><script src="../assets/js/color-modes.js"></script>
    ...
    <title>Edit Template · Bootstrap v5.3</title>
...
<main class="form-signin w-100 m-auto">
    <form method="post">
        ...
        <h1 class="h3 mb-3 fw-normal">Editing user with ID <?= $userData->id ?? "" ?></h1>
        ...
        <div class="form-floating mt-2">
            <input type="text" class="form-control" id="firstName" name="firstName" value="<?= $userData->firstName ?? '' ?>">
        ...
        <div class="form-floating mt-2">
            <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth" value="<?= $userData->dateOfBirth ?? '' ?>">
        ...
        <button class="btn btn-success w-100 py-2 mt-2" type="submit"
                id="finalAction" name="finalAction" value="confirm">Confirm changes</button>
